...
<link rel="stylesheet" href="assets/css/editprofile.css" media="screen">
    ...
    <meta property="og:title" content="회원 정보 수정">
...
borders: bottom !important; border-width: 2px !important; border-color: var(--custom-color-3) !important
    ...
    <section class="u-clearfix u-section-1" id="sec-cc85">
      <div class="u-clearfix u-sheet u-sheet-1">
        <p class="u-custom-font u-text u-text-custom-color-14 u-text-default u-text-1">내 정보 수정 </p>
        <div class="u-form u-form-1">
          <form action="https://forms.nicepagesrv.com/v2/form/process" class="u-clearfix u-form-spacing-30 u-form-vertical u-inner-form" source="email" name="form" style="padding: 10px;">
            <div class="u-form-group u-form-name">
              <label for="name-7697" class="u-custom-font u-label u-text-custom-color-14 u-label-1">닉네임 변경</label>
              <input type="text" placeholder="바꾸고 싶은 닉네임을 입력해주세요." id="name-7697" name="chnick" class="u-custom-font u-input u-input-rectangle u-input-1" required="">
            </div>
            <div class="u-form-group u-form-group-2">
              <label for="text-d3e8" class="u-custom-font u-label u-text-custom-color-14 u-label-2">비밀번호 변경</label>
              <input type="text" placeholder="바꾸고 싶은 비밀번호를 입력해주세요." id="text-d3e8" name="chpw" class="u-custom-font u-input u-input-rectangle u-input-2">
            </div>
            <div class="u-form-group u-form-group-3">
              <label for="text-8e3b" class="u-custom-font u-label u-text-custom-color-14 u-label-3">이메일 변경</label>
              <input type="text" placeholder="바꾸고 싶은 이메일을 입력해주세요." id="text-8e3b" name="chmail" class="u-custom-font u-input u-input-rectangle u-input-3">
            </div>
            <div class="u-align-left u-form-group u-form-submit">
              <a href="#" class="u-btn u-btn-submit u-button-style u-custom-color-14 u-custom-font u-hover-custom-color-15 u-btn-1">완료 </a>
