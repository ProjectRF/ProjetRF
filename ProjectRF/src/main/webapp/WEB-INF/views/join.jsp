...
.u-sticky-fixed.u-sticky-abde:before, .u-body.u-sticky-fixed .u-sticky-abde:before
 ...
 <section class="u-align-center u-clearfix u-section-1" id="sec-16bd" data-animation-name="" data-animation-duration="0" data-animation-delay="0" data-animation-direction="">
      <div class="u-clearfix u-sheet u-sheet-1">
      <form action="joinok" method="post">
        <h2 class="u-align-center u-custom-font u-text u-text-custom-color-14 u-text-1">회원가입</h2>
        <p class="u-align-left u-custom-font u-text u-text-custom-color-14 u-text-2">아이디</p>
        	<input name = "memId" type="text" class="u-border-1 u-border-grey-30 u-shape u-shape-rectangle u-shape-1">
        <p class="u-align-left u-custom-font u-text u-text-custom-color-14 u-text-3">비밀번호</p>
        	<input name="memPw" type="password" class="u-border-1 u-border-grey-30 u-shape u-shape-rectangle u-shape-2">
        <p class="u-align-left u-custom-font u-text u-text-custom-color-14 u-text-4">닉네임</p>
        	<input name="memNick" type="text" class="u-border-1 u-border-grey-30 u-shape u-shape-rectangle u-shape-3">
        <p class="u-align-left u-custom-font u-text u-text-custom-color-14 u-text-5">이메일 </p>
        	<input name = "memEmail" type="text" class="u-border-1 u-border-grey-30 u-shape u-shape-rectangle u-shape-4">
        <p class="u-align-left u-custom-font u-text u-text-custom-color-14 u-text-6">성별 </p>
        <p class="u-align-left u-custom-font u-text u-text-custom-color-14 u-text-7">생년월일 </p>

	        <select name="memGender" class="u-border-1 u-border-grey-30 u-shape u-shape-rectangle u-shape-5">
	        	 <option value="남성">남성</option>
	    		 <option value="여성">여성</option>
	        </select>
        
        
      		 <input name="memBirthdate" type="date" class="u-border-1 u-border-grey-30 u-shape u-shape-rectangle u-shape-6">
        
        
        <a href="https://nicepage.com/c/about-us-html-templates" class="u-btn u-button-style u-custom-color-14 u-custom-font u-hover-custom-color-15 u-btn-1">돌아가기</a>
        
        <button type = "submit" class="u-btn u-button-style u-custom-color-14 u-custom-font u-hover-custom-color-15 u-btn-2">완료 </button>
        </form>
      </div>
    </section>
